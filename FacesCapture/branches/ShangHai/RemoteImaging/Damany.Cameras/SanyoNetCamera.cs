    ...
    public partial class SanyoNetCamera : IIpCamera, IDisposable
    {
        ...
        public void SetDefaultPosition()
        {
            try
            {
                ...
                if (!strUri.Substring(strUri.Length - 1, 1).Equals("/"))
                {
                    strUri = strUri + "/";
                }
                var uri = String.Format("{0}cgi-bin/opecmd.cgi?ope=8&registration=8", strUri);
        ...
        public void ReturnDefaultPosition()
        {
            try
            {
                ...
                var uri = String.Format("{0}cgi-bin/opecmd.cgi?ope=11&execution=8", strUri);
        ...
        public void SetFocusIn()
        {
            try
            {
                ...
                var uri = String.Format("{0}cgi-bin/opecmd.cgi?ope=49&action=0", strUri);
        ...
        public void SetFocusOut()
        {
            try
            {
                ...
                var uri = String.Format("{0}cgi-bin/opecmd.cgi?ope=49&action=1", strUri);
        ...
        public void SetIrisOpen()
        {
            try
            {
                ...
                var uri = String.Format("{0}cgi-bin/opecmd.cgi?ope=50&action=0", strUri);
        ...
        public void SetIrisClose()
        {
            try
            {
                ...
                var uri = String.Format("{0}cgi-bin/opecmd.cgi?ope=50&action=1", strUri);
        ...
        public void StopCaptureH264Image()
        {
            EnsureConnected();

            var uri = new Uri(this.Uri, "liveimg.cgi?stream=0").ToString();
        ...
        public byte[] CaptureH264ImageBytes()
        {
            EnsureConnected();
            var uri = new Uri(this.Uri, "liveimg.cgi?stream=1").ToString();
        ...
        private void SetCameraPositionProperty(string uri)
        {
            EnsureConnected();

            var reply = GetHttpRequest(uri, this.cookies, true);
            reply.Close();
        }
